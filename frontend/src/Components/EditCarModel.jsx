...
export default function EditCarModel({setIsOpen}) {
    ...
    return (
        <>
            ...
            <div className="min-h-screen flex items-center justify-center backdrop-blur-sm  absolute top-0 w-full left-0 z-100">
